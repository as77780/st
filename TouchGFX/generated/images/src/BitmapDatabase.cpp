// 4.12.2 dither_algorithm=2 alpha_dither=yes layout_rotation=0 opaque_image_format=RGB888 non_opaque_image_format=ARGB8888 section=ExtFlashSection extra_section=ExtFlashSection generate_png=no 0x6659739f
...
extern const unsigned char _dark_radio_buttons_radio_round_button_active[]; // BITMAP_DARK_RADIO_BUTTONS_RADIO_ROUND_BUTTON_ACTIVE_ID = 11, Size: 44x44 pixels
extern const unsigned char _dark_radio_buttons_radio_round_button_inactive[]; // BITMAP_DARK_RADIO_BUTTONS_RADIO_ROUND_BUTTON_INACTIVE_ID = 12, Size: 44x44 pixels
extern const unsigned char _dark_radio_buttons_radio_round_button_normal[]; // BITMAP_DARK_RADIO_BUTTONS_RADIO_ROUND_BUTTON_NORMAL_ID = 13, Size: 44x44 pixels
extern const unsigned char _dark_radio_buttons_radio_round_button_pressed[]; // BITMAP_DARK_RADIO_BUTTONS_RADIO_ROUND_BUTTON_PRESSED_ID = 14, Size: 44x44 pixels
extern const unsigned char _dark_slider_horizontal_medium_indicators_slider2_round_nob[]; // BITMAP_DARK_SLIDER_HORIZONTAL_MEDIUM_INDICATORS_SLIDER2_ROUND_NOB_ID = 15, Size: 54x34 pixels
extern const unsigned char _dark_slider_horizontal_medium_slider_round_back[]; // BITMAP_DARK_SLIDER_HORIZONTAL_MEDIUM_SLIDER_ROUND_BACK_ID = 16, Size: 352x15 pixels
extern const unsigned char _dark_slider_horizontal_medium_slider_round_fill[]; // BITMAP_DARK_SLIDER_HORIZONTAL_MEDIUM_SLIDER_ROUND_FILL_ID = 17, Size: 352x15 pixels
extern const unsigned char _dark_textures_carbon_fibre[]; // BITMAP_DARK_TEXTURES_CARBON_FIBRE_ID = 18, Size: 24x22 pixels
extern const unsigned char _down_arrow[]; // BITMAP_DOWN_ARROW_ID = 19, Size: 32x19 pixels
extern const unsigned char _down_arrow_pressed[]; // BITMAP_DOWN_ARROW_PRESSED_ID = 20, Size: 32x19 pixels
extern const unsigned char _equalizer[]; // BITMAP_EQUALIZER_ID = 21, Size: 48x48 pixels
extern const unsigned char _ic[]; // BITMAP_IC_ID = 22, Size: 64x64 pixels
extern const unsigned char _ico[]; // BITMAP_ICO_ID = 23, Size: 48x48 pixels
extern const unsigned char _up_arrow[]; // BITMAP_UP_ARROW_ID = 24, Size: 32x19 pixels
extern const unsigned char _up_arrow_pressed[]; // BITMAP_UP_ARROW_PRESSED_ID = 25, Size: 32x19 pixels
